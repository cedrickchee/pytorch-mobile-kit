...
public class InfoViewFactory {
  ...
  public static final int INFO_VIEW_TYPE_IMAGE_CLASSIFICATION_RESNEXT = 3;
  public static final int INFO_VIEW_TYPE_IMAGE_CLASSIFICATION_SQUEEZENET = 4;

  public static View newInfoView(Context context, int infoViewType, @Nullable String additionalText) {
    LayoutInflater inflater = LayoutInflater.from(context);

    if (INFO_VIEW_TYPE_IMAGE_CLASSIFICATION_RESNEXT == infoViewType) {
      ...
      infoTextView.setText(R.string.vision_card_resnext_title);
      StringBuilder sb = new StringBuilder(context.getString(R.string.vision_card_resnext_description));
      if (additionalText != null) {
        sb.append('\n').append(additionalText);
      }
      descriptionTextView.setText(sb.toString());
      return view;
    } else if (INFO_VIEW_TYPE_IMAGE_CLASSIFICATION_RESNET == infoViewType) {
      View view = inflater.inflate(R.layout.info, null, false);
      TextView infoTextView = view.findViewById(R.id.info_title);
      TextView descriptionTextView = view.findViewById(R.id.info_description);
      ...
      descriptionTextView.setText(sb.toString());
      return view;
    } else if (INFO_VIEW_TYPE_IMAGE_CLASSIFICATION_SQUEEZENET == infoViewType) {
      View view = inflater.inflate(R.layout.info, null, false);
      TextView infoTextView = view.findViewById(R.id.info_title);
      TextView descriptionTextView = view.findViewById(R.id.info_description);

      infoTextView.setText(R.string.vision_card_squeezenet_title);
      StringBuilder sb = new StringBuilder(context.getString(R.string.vision_card_squeezenet_description));
      if (additionalText != null) {
        sb.append('\n').append(additionalText);
      }
      descriptionTextView.setText(sb.toString());
